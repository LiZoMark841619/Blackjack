...
class Game:
    ...
    def get_insurance(self, player: str, insurance: int) -> dict:
        self.game.get_players_bets()[player] += insurance

    def surrendering(self, player: str) -> dict:
